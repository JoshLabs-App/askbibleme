...
export const strings = {
  ...
  home: {
    title: "首页",
    lead: "全屏自然影像与经文轮播。",
    body: "此处为原生壳：画面与曲库将逐步与线上 Selah 对齐。若你已在网站后台配置自然影片，后续版本会在此直接呈现；当前先保留安静占位。",
    loadError: "无法加载自然配置。请确认本机已运行网站（默认端口 3450）或已设置 EXPO_PUBLIC_SELAH_BASE_URL。",
    retry: "重试",
    loading: "加载中…",
    apiHint: `当前站点：开发模式见代码内默认地址；生产请配置 EXPO_PUBLIC_SELAH_BASE_URL。`,
  },
  nature: {
    emptyTitle: "仍未配置背景影片",
