...
export const BUNDLED_AMBIENT_SCENE_AUDIO: Partial<Record<NatureAmbientSceneSlotId, number>> = {
  ...
  "scene-rain": require("../../assets/audio/scenes/scene-rain-heavy-300.mp3"),
  ...
  "scene-birds": require("../../assets/audio/scenes/scene-birds-forest-319791.mp3"),
  "scene-wind": require("../../assets/audio/scenes/scene-windstorm-60.mp3"),
