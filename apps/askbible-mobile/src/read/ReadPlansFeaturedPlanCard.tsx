...
const styles = StyleSheet.create({
  ...
  cardTitle: { marginTop: 6, fontSize: 19, ...parchmentSans(600), color: c.ink },
  cardSubtitle: { marginTop: 4, fontSize: 15, color: c.muted },
  methodLead: {
    marginTop: 10,
    fontSize: 16,
    lineHeight: 24,
  ...
  cardBlurb: { marginTop: 8, fontSize: 15, lineHeight: 22, color: c.muted },
  cardMeta: { marginTop: 10, fontSize: 13, color: c.faint },
  ...
  cardOpen: { fontSize: 14, ...parchmentSans(500), color: c.muted, paddingTop: 2 },
