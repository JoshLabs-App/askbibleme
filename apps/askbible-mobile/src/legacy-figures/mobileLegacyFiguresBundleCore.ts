import bundledJson from "./mobile-legacy-figures.json";
...
export function getBundledMobileLegacyFiguresBundle(): MobileLegacyFiguresBundle {
  return bundledJson as MobileLegacyFiguresBundle;
}
