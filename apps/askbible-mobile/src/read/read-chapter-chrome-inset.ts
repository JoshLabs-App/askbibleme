...
export function readChapterScrollBottomPad(safeBottom: number, withActionRow: boolean): number {
  const base = READ_CHAPTER_SCROLL_BOTTOM_BASE + safeBottom;
  return withActionRow ? base + READ_CHAPTER_SCROLL_BOTTOM_EXTRA : base;
}
