...
export function HomeVerseRotator({
  ...
  const lineClass = (() => {
    ...
    if (isNature) {
      return isDark
        ? "m-0 font-sans text-[clamp(1.04rem,3.85vw+0.16rem,1.34rem)] font-medium leading-[1.46] tracking-[0.018em] text-white/[0.96] [text-shadow:0_1px_2px_rgba(0,0,0,0.38),0_2px_14px_rgba(0,0,0,0.22)] [@media(max-height:500px)_and_(orientation:portrait)]:text-[clamp(0.95rem,3.2vw+0.12rem,1.12rem)] [@media(max-height:500px)_and_(orientation:portrait)]:leading-[1.4]"
