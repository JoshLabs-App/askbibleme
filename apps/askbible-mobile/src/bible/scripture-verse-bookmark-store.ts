/** 与 `lib/bible/scripture-verse-bookmarks.ts` 同构（勿引用仓库根 lib，Metro 无法打包） */

export const SCRIPTURE_VERSE_BOOKMARKS_STORAGE_KEY = "askbible-scripture-verse-bookmarks-v1";
export const SCRIPTURE_VERSE_BOOKMARKS_STORAGE_KEY_LEGACY = "selah-scripture-verse-bookmarks-v1";
