...
import { formatReadingPlanChapterTotalLabel } from "@/lib/bible/reading-plans/plan-chapter-total";
  ...
  return (
    <div className="read-bible-today-reading-row flex items-start gap-2 py-1">
      ...
      >
        ...
        <span
          className="read-bible-today-reading-bar mt-1 block h-1 w-full overflow-hidden rounded-sm"
          role="progressbar"
          aria-valuemin={0}
          aria-valuemax={100}
        ...
        <span
          className="mt-0.5 block text-left text-[11px] font-medium leading-[15px] tracking-wide"
