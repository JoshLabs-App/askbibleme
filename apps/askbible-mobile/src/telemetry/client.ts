...
import { isTelemetryConsentGranted } from "./consent";
...
function isTelemetryDisabled(): boolean {
  return process.env.EXPO_PUBLIC_TELEMETRY_DISABLED === "1" || isMobileOfflineFirst();
}

function telemetryAllowed(): boolean {
  return !isTelemetryDisabled() && isTelemetryConsentGranted();
}
