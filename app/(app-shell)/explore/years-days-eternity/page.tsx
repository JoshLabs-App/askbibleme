...
export const metadata = {
  title: sitePageTitle("年日与永恒"),
  description: "从创造到永生盼望，按救赎史慢读相关经文。",
};
...
async function loadEnScriptureOverrides(locale: AppLocale) {
  if (locale !== "en") return { enScriptureBodyByRef: undefined, enRefLabelByRaw: undefined };
...
export default async function ExploreYearsDaysEternityPage() {
